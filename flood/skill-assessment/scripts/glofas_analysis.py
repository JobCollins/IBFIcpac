...
from db_utils import get_glofas_data # utility functions to access database
...
def prepare_glofas_stations_data(country='Kenya', path='.'):
    """
...
def get_impact_data(date_format, admin_column, ct_code, path):
    ...
    # possibility to filter on flood event certainty/impact severity column for Kenya instead of previous line
